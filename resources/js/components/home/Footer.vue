<template>
    <footer class="border-t border-zinc-800 bg-zinc-950 px-6 py-12 text-white">
        <div class="mx-auto max-w-7xl">
            <div class="grid gap-10 md:grid-cols-3">
                ...
                <div>
                    ...
                    >
                        Bicicletas y equipamiento para quienes viven por y para
                        el sendero.
                    </p>
                </div>
            ...
            <!-- Copyright -->
            <div
                class="mt-12 border-t border-zinc-800 pt-6 text-sm text-zinc-500"
            >
                © 2026 DirtFlow X. Todos los derechos reservados.
            </div>
        </div>
    </footer>
</template>
